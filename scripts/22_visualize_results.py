...
def main():
    ...
    for idx, candidate in enumerate(candidates.itertuples()):
        ...
        popup = folium.Popup(
            ...
            <tr>
                <td>Hospital</td>
                <td align="right">{candidate.hospital_score:.2f}</td>
            </tr>

            <tr>
                <td>Clinic</td>
                <td align="right">{candidate.clinic_score:.2f}</td>
            </tr>

            <tr>
                <td>Doctor</td>
                <td align="right">{candidate.doctor_score:.2f}</td>
            </tr>

            <tr>
                <td>Competition</td>
                <td align="right">-{candidate.competition_score:.2f}</td>
            </tr>

            <tr>
                <td>Accessibility</td>
                <td align="right">{candidate.accessibility_score:.2f}</td>
            </tr>

            <tr>
                <td>Road</td>
                <td align="right">{candidate.road_score:.2f}</td>
            </tr>

            <tr>
                <td><b>Prescription</b></td>
                <td align="right"><b>{candidate.prescription_score:.2f}</b></td>
            </tr>

            <tr>
                <td>Population</td>
                <td align="right">{candidate.population:.2f}</td>
            </tr>

            <tr>
                <td>Population Score</td>
                <td align="right">{candidate.population_score:.2f}</td>
            </tr>
